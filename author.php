    ...
    <div id="main-content">
      <div class="container">
        ...
        $sql= "SELECT p.post_id,p.title,p.description,p.category,p.post_date,p.author,p.post_img,u.username,c.category_name FROM post  p JOIN user  u 
            ...
            JOIN category  c ON p.category=c.category_id WHERE p.author={$a_id}
        ...
        ?>    
                    ...
                    <?php 
                      ...
                      if($page>1){
                        echo "<li><a href='author.php?page=".($page-1)."& u_id=".$a_id."'> Prev</a></li>";
                      }
                      for($i=1;$i<=$tot_page;$i++){
                        if($i==$page){
                         ...
                         echo "<li class='".$active."'><a href='author.php?page=".$i." & u_id=".$a_id."'> ".$i." </a></li>";
                        }
                         if($tot_page>$page){
                        echo "<li><a href='author.php? page=".($page+1)."& u_id=".$a_id."'> Next</a></li>";
                      }
                     echo "</ul>";
                        }
                     }
